...
- 박스 기본설질(block/inline)

- block 요소 whidth/height
  - 크기 지정 안했을 때
    - 너비 : 부모요소 영역 너비만큼 채워짐
    - 높이 : 자식요소 영역 높이만큼 지정됨
  - px(픽셀) 지정
...
#### padding(안쪽여백)
- 4방향 독립적으로 적용(4개중 일부만 사용)
  - padding-top
  - padding-right
  - padding-bottom
  - padding-left

- 축약 표현(4방향 동시 적용 값을 따로 적용)
  - 값 4개 : 각 방향 각각 적용
  - 값 3개 : 위,아래, 왼쪽-오른쪽 적용
  - 값 2개 : 위-아래, 왼쪽-오른쪽 적용
  - 값 1개 : 위-아래-왼쪽-오른쪽 적용
...
전체크기 : 400px / padding:20px, border:1px, width:?
=> 400 - 40 - 2 = 358 = width
```

- box-sizing
  - content-box : content 기준(기본)
  - border-box : box 기준 (추천)
  - 
...
- 픽셀 밀도
  - 모바일 디바이스의 화면 크기를 작게해서 더 많은 수의 픽셀이 표현될 수 있도록 밀도를 높인 것
